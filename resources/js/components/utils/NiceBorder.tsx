...
export default function NiceBorder({ children, className }: NiceBorderProps) {
  return (
    <div
      className={clsx(
        className,
        'group relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-gray-900 rounded-lg bg-gradient-to-br from-cyan-500 to-blue-500'
      )}
    >
